...
import check.com.passin.repositores.EventRepository;
...
public class EventService {
    private final EventRepository eventRepositoy;
    ...
    public EventIdDTO createEvent(EventRequestDTO eventDTO) {
        ...
        this.eventRepositoy.save(newEvent);
    ...
    private Event getEventById(String eventId) {
        return this.eventRepositoy.findById(eventId).orElseThrow(() ->
